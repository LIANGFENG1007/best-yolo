...
检测到新版本后，“前往 GitHub 发布页”会直接调用系统默认浏览器。若系统没有成功打开浏览器，请点击弹窗中的发布页链接，或使用“复制链接”后在浏览器中手动打开。

## 视频切片右侧内容看不全

视频切片页的右侧设置区会在界面放大或窗口较小时自动出现滚动条。把鼠标放到右侧设置区滚动，或拖动右侧滚动条，即可查看“抽帧设置”和“切好的图”下面的内容；左侧视频预览不会随右侧滚动。
